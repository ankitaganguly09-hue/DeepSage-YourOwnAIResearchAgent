...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="DeepSage · Your Own AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
st.markdown("""
<div class="notice">
    DeepSage · Built by Ankita Ganguly · Powered by LangChain multi-agent pipeline · Built with Streamlit · 2026
</div>
""", unsafe_allow_html=True)